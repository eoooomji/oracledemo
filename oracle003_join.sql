...
5. SELF JOIN
   ...
   하나의 테이블에 같은 데이터가 두개의 걸럼에 다른 목적으로 저장되어 있는 경우
...
/*----------------------------------------------------------------------
6. USING
   두 개의 테이블이 INNER JOIN으로 조인 될 때 조인하고자 하는 두 테이블의 컬럼명이 같을 경우 
